...
const props = defineProps({
  userId: String,
  gradients: Array,
  showModalBrush: Boolean,
  showModalPrivacity: Boolean,
});
...
const emits = defineEmits([
  ...
  "setGradient",
  "onNameChange",
  "update:showModalBrush",
  "update:showModalPrivacity",
]);
...
<template>
  ...
  >
    <div class="flex flex-row items-start justify-around gap-8">
      <Dialog
        :open="showModalBrush"
        @update:open="emits('update:showModalBrush', $event)"
      >
        <DialogContent>
          <DialogHeader>
            <DialogDescription>
              <div class="flex flex-col w-full">
                <FormField v-slot="{ componentField }" name="cover">
                  <FormItem v-auto-animate>
                    ...
                    <FormControl>
                      <div
                        class="flex flex-wrap justify-start gap-x-4 gap-y-4 border border-gray-500 rounded-sm p-2 bg-input pr-2 pl-4 pt-2 pb-2"
                      >
                        <button
                          ...
                          :class="[
                            gradient,
                            'text-white font-light rounded-full text-sm w-[40px] h-[40px]',
      ...
      <Dialog
        :open="showModalPrivacity"
        @update:open="emits('update:showModalPrivacity', $event)"
      >
        <DialogContent>
          <DialogHeader>
            <DialogDescription>
              <div class="flex flex-col w-full">
                <FormField v-slot="{ componentField }" name="isPublic">
                  <FormItem v-auto-animate class="space-y-0 pt-[14px]">
      ...
      <!-- primera seccion -->
      <div class="flex flex-col md:w-3/5 bg-background p-4 rounded-md space-y-6">
        <!-- Nombre -->
        ...
        <div class="flex flex-col md:flex-row gap-4 md:gap-8">
          ...
          <div class="flex flex-col md:w-3/6">
            <FormField v-slot="{ componentField }" name="startDate">
              <FormItem class="flex flex-col" v-auto-animate>
                <FormLabel class="font-thin! pb-2">Fecha de inicio</FormLabel>
                <Popover>
          ...
          <div class="flex flex-col md:w-3/6">
            <FormField v-slot="{ componentField }" name="endDate">
              <FormItem class="flex flex-col" v-auto-animate>
                <FormLabel class="font-thin! pb-2">Fecha de término</FormLabel>
                <Popover>
                  <PopoverTrigger as-child>
                    <FormControl>
                      <Button
      ...
      <div class="flex flex-col align-top w-full">
    ...
    <div class="flex flex-col items-end py-4">
      <Button type="submit" class="w-/6" :disabled="!loading">Continuar</Button>
    </div>
  </form>
</template>
